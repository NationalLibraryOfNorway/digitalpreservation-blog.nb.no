...
| -------------------------------------- | ----------------------------------------------------- | ----------------------------------------------- |
| Bevaring av digitaliserte bilder       | <ul><li>TIFF (Tagged Image File Format), revision 6 [^1]  |                                                 |
| Bevaring av plakater                   | <ul><li>PDF/A Family, PDF for Long-term Preservation [^2] | <ul><li>PDF (Portable Document Format) Family [^28] |
| Tilgangskopier                         | <ul><li>JPEG 2000 Part 2 (Extensions) jpf (jpx) [^3]      |                                                 |


## Levende bilder
| <div style="width:255px">Formål</div>                     | Foretrukne formater                                                                                                                                                                                                                                                                        | Akseptable formater                                                                                                                 |
| --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------- |
| Filmmastere og filmdigitalisering                         | <ul><li>Matroska/FFV1/PCM (Matroska File Format with FFV1 video encoding) [^8]<li>DPX (Digital Moving-Picture Exchange), Version 2.0 [^9] <li> TIFF sequence [^1]<li>MPEG-4, Advanced Video Coding (Part 10) (H.264)/PCM (lossless, ukomprimert mezzanin) [^15] <li> OpenEXR [^11] <li> Apple Prores4444/mov [^12]<li> DNxHR444  | <ul><li>Apple ProRes 422 High Quality/mov [^13]<li> DNxHR HQX/HQ                                    |
| Fjernsyn (master/sendemaster), VOD,hjemmevideo og tilgang | <ul><li>Interoperable Master Format (IMF) [^14]<li>MXF/XDCAM<li>MXF OP1a [^32]                                                                                                                                                                                                                 | <ul><li>MPEG-4, Advanced Video Coding (Part 10) (H.264) [^15]<li> MPEG-2 Video Encoding (H.262) [^16] (50Mbit/s, bare Inter-frame-kodet)|
| Filmdistribusjon (kino)                                   | <ul><li>DCP, Version 1.0 (Digital Cinema Initiative Distribution Package) [^17] (ukryptert)<li> IMF (Interoperable Master Format) [^14]  (ukryptert)                                                                                                                                           |                                                                                                                                     |
| Digitalisert video                                        | <ul><li>Matroska/FFV1/PCM [^8]                                                                                                                                                                                                                                                                 |                                                                                                                                     |
| Filmlyd (sluttmix/audiomaster)                            | <ul><li>BWF (Broadcast WAVE Audio File Format), Version 2 [^4]<li>WAVE Audio File Format with LPCM audio [^5]<li>FLAC (Free Lossless Audio Codec), Version 1.1.2 [^6]                                                                                                                          |                                                                                                                                     |
| Undertekster                                              | <ul><li>SRT (SubRip Subtitle format) [^25]<li> PAC (Presentation Audio/Video Coding)<li> XML                                                                                                                                                                                                   |                                                                                                                                     |


## Lyd
| <div style="width:255px">Formål</div>                                                                                                    | Foretrukne formater                                                                                                                             | Akseptable formater                                                                                                          |
| ---------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| Mastere og lyddigitalisering<br><ul><li>Minimum bitdybde: 16 bit <li>Anbefalt bitdybde: 24 bit <li>Minimum samplingsfrekvens: 44100 Hz       | <ul><li>BWF (Broadcast WAVE Audio File Format), Version 2 [^4]<li>WAVE Audio File Format with LPCM audio [^5]<li>MBWF/RF64 (Multichannel BWF) [EBU TECH 3306] [^35] | <ul><li>FLAC (Free Lossless Audio Codec), Version 1.1.2 [^6] <li>AIFF LPCM (Audio Interchange File Format with LPCM Audio) [^36] |

## Nettarkiv
| <div style="width:255px">Formål</div> | Foretrukne formater                                                                    | Akseptable formater |
| ------------------------------------- | -------------------------------------------------------------------------------------- | ------------------- |
| Netthøsting                           | <ul><li>WACZ (Web Archive Collection Zipped) [^26]<li>WARC (Web ARChive file format) [^27] |                     |


## Tekst
| <div style="width:255px">Formål</div> | Foretrukne formater                                                                                               | Akseptable formater                             |
| --------------------------------------| ----------------------------------------------------------------------------------------------------------------- | ------------------------------------------------|
| Skannet tekst                         | <ul><li>JPEG 2000 Part 1 (Core) jp2 File [^29]                                                                        |                                                 |
| OCR                                   | <ul><li>ALTO XML [^30]                                                                                                |                                                 |
| Digital tekst                         | <ul><li>PDF/A Family, PDF for Long-term Preservation [^2] <li> EPUB (Electronic Publication) File Format Family [^31] | <ul><li>PDF (Portable Document Format) Family [^28] |
| Tilgangskopier                        | <ul><li>JPEG 2000 Part 2 (Extensions) jpf (jpx) [^3]                                                                  |                                                 |
| Forsidebilder                         | <ul><li>JPEG Image Encoding Family [^33] <li> PNG (Portable Network Graphics) [^34]                                   |                                                 |
