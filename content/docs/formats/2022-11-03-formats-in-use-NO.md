...
<!-- 
| Kategori       | <div style="width:255px">Formål</div>                                                           | Foretrukne format                                                                                                                                                                                                                  | Akseptable format                                                                                                                   |
| -------------- | ------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| Bilder         | Bevaring av digitaliserte bilder           | <li>TIFF (Tagged Image File Format), revision 6 [^1]                                                                                                                                                                               |                                                                                                                                     |
| Bilder         | Bevaring av plakater                       | <li>PDF/A Family, PDF for Long-term Preservation [^2]                                                                                                                                                                              | <li>PDF (Portable Document Format) Family [^28]                                                                                     |
| Bilder         | Tilgangskopier                             | <li>JPEG 2000 Part 2 (Extensions) jpf (jpx) [^3]                                                                                                                                                                                   |                                                                                                                                     |
| Lyd            | Mastere og lyddigitalisering               | <li>BWF (Broadcast WAVE Audio File Format), Version 2 [^4]<li>WAVE Audio File Format with LPCM audio [^5]                                                                                                                          | <li>FLAC (Free Lossless Audio Codec), Version 1.1.2 [^6]                                                                            |
| Lyd            | Distribusjons- og tilgangskopier           | <li>AAC (.m4a/.mp4) [^7]                                                                                                                                                                                                           |                                                                                                                                     |
| Levende bilder | Filmmastere og filmdigitalisering          | <li>Matroska/FFV1/PCM (Matroska File Format with FFV1 video encoding) [^8]<li>DPX (Digital Moving-Picture Exchange), Version 2.0 [^9] <li> TIFF sequence [^10] <li> OpenEXR [^11] <li> Apple Prores4444/mov [^12]<li> DNxHR444     | <li>Apple ProRes 422 High Quality/mov [^13]<li> DNxHR HQX/HQ                                                                        |
| Levende bilder | Filmmastere for VOD/hjemmevideo og tilgang | <li>Interoperable Master Format (IMF) [^14]                                                                                                                                                                                        | <li>MPEG-4, Advanced Video Coding (Part 1) (H.264) [^15]<li> MPEG-2 Video Encoding (H.262) [^16] (50Mbit/s, bare Inter-frame-kodet) |
| Levende bilder | Filmdistribusjon (kino)                    | <li>DCP, Version 1.0 (Digital Cinema Initiative Distribution Package)  [^17] (ukryptert)<li> IMF (Interoperable Master Format) [^14]  (ukryptert)                                                                                  |                                                                                                                                     |
| Levende bilder | Digitalisert video                         | <li>Matroska/FFV1/PCM [^8]                                                                                                                                                                                                         |                                                                                                                                     |
| Levende bilder | Fjernsyn                                   | <li>MXF/XDCAM<li> IMF (Interoperable Master Format) [^14]                                                                                                                                                                          | <li>MPEG-4, Advanced Video Coding (Part 1) (H.264) [^15]                                                                            |
| Levende bilder | Filmlyd (sluttmix/audiomaster)             | <li>BWF (Broadcast WAVE Audio File Format), Version 2 [^4]<li>WAVE Audio File Format with LPCM audio [^5]<li>FLAC (Free Lossless Audio Codec), Version 1.1.2 [^6]                                                                  |                                                                                                                                     |
| Levende bilder | Undertekster                               | <li>SRT (SubRip Subtitle format) [^25]<li> PAC (Presentation Audio/Video Coding)<li> XML                                                                                                                                           |                                                                                                                                     |
| Nettarkiv      | Netthøsting                                | <li>WACZ (Web Archive Collection Zipped) [^26]<li>WARC (Web ARChive file format) [^27]                                                                                                                                             |                                                                                                                                     |
| Tekst          | Skannet tekst                              | <li>JPEG 2000 Part 1 (Core) jp2 File [^29]                                                                                                                                                                                         |                                                                                                                                     |
| Tekst          | Skannet tekst (OCR)                        | <li>ALTO XML [^30] (OCR)                                                                                                                                                                                                           |                                                                                                                                     |
| Tekst          | Trykkemaster                               | <li>PDF/A Family, PDF for Long-term Preservation [^2] <li> EPUB (Electronic Publication) File Format Family [^31]                                                                                                                  |  <li>PDF (Portable Document Format) Family [^28]                                                                                    |
...
[^33]: Sustainability of digital formats: Planning for Library of Congress Collections. MPEG-4, Advanced Video Coding (Part 10) (H.264). (2011a, December 5). https://www.loc.gov/preservation/digital/formats/fdd/fdd000081.shtml 
