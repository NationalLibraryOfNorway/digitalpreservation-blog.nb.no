...
Modellen som styrer tilgang til å avlevere data til eller hente data fra DPS, har fire hovedkomponenter: *klienter*, *roller*, *bevaringsavtaler*, og *informasjonspakker*. For kontekst om hva som leveres og hentes, se [Datahåndtering](/docs/dps/data/) og [Metadatahåndtering](/docs/dps/metadata/).
