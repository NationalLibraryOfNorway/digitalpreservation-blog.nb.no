...
Digital provenance metadata refers to information about events in the lifecycle of the digital object. This data is typically formatted using PREMIS. Note that certain types of metadata in the form of PREMIS-events are recommended to be submitted through the Submission API. You can read more about this here [Events/preservation metadata](/content/docs/dps/api/submission/Events/index.md).
