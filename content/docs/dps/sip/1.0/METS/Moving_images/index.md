...
This is a list of requirements for the METS.xml file for moving image packages delivered to the National Library of Norway. These are additional requirements beyond what is defined in [Use of METS.xml](https://digitalpreservation.no/docs/dps/sip/1.0/mets/). <br><br>
