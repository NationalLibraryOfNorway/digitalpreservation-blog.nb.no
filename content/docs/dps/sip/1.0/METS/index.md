...
| **NBSIP19** | **Technical metadata**<br>`mets/amdSec/techMD`<br><br> If technical metadata for the data files in a representation is available in the information package, this element **MUST** be used to describe it. <br><br> Direct embedding of metadata using `mets/amdSec/mdWrap` is discouraged. | **SHOULD** | **1..1** |
