...
The [E-ARK standard](https://dilcis.eu/) is a common European specification for structuring, packaging, and transferring digital objects. The standard is based on established frameworks and standards for digital preservation, such as the OAIS standard, PREMIS, and METS. E-ARK defines common requirements for the structure, content, and metadata of information packages (SIP, AIP, and DIP), and facilitates interoperability between system vendors, data producers, and preservation institutions.
...
{{< cards >}}
  {{< card link="scope" title="Package, representation and data scope" icon="document-text">}}
  {{< card link="metadata" title="Metadata primer" icon="document-text">}}
  {{< card link="structure-requirements" title="Requirements for SIP structure" icon="document-text" >}}
  {{< card link="mets" title="METS.xml requirements" icon="document-text" >}}
  {{< card link="examples" title="Examples" icon="document-text">}}
{{< /cards >}}
