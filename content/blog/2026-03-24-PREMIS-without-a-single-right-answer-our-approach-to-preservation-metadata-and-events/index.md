...
In addition to recommending the submission of preservation metadata as events via the API, it is also possible to include this type of metadata as part of the information package (SIP). More information can be found here: [SIP 1.0 (E-ARK)](/docs/dps/sip/).
